...
शीर्षकों को डिस्प्ले-स्तर की letter-spacing (`-0.025em`) थीम से ही मिलती है, इसलिए आप `display` के लिए जो भी चुनें — Inter डिफ़ॉल्ट जैसे टेक्स्ट फ़ॉन्ट सहित — शीर्षक बड़े आकार में सही दिखते हैं, फ़ॉन्ट में निर्मित tracking पर निर्भर हुए बिना।
