...
Os títulos recebem letter-spacing de display (`-0.025em`) do próprio tema, então o que você escolher para `display` — incluindo fontes de texto como o padrão Inter — fica correto nos tamanhos de título, sem depender do tracking embutido na fonte.
